...
We've written this book for anyone interested in a working with OMOP CDM instances using a tidyverse style approach. That is, human centered, consistent, composable, and inclusive (see [TODO](https://design.tidyverse.org/unifying.html) for more details on these principles).

New to R? We recommend you to take a look to [R for data science](https://r4ds.had.co.nz/) before reading this book. We assume that you have [R](TODO) installed and together with an adequate IDE (TODO) such as [R Studio](TODO) or [positron](TODO). See this [tutorial](https://rstudio-education.github.io/hopr/starting.html) if you need guidance on how to get started. The book uses multiple packages, that you will need to install see the list in the [R packages](TODO) section.
...
Please if you found this book useful help us citing it: TODO.
...
The source code for the book can be found at this [Github repository](https://github.com/oxford-pharmacoepi/Tidy-R-programming-with-OMOP), we welcome TODO to help the dissemination of the book.

## R Packages

This book is rendered automatically though [GitHub Actions](TODO) using the following version of packages:
...
TODO Note we only included the packages called explicitly in the book.
