...
- **1** [Tidy R programing with the OMOP CDM](TODO)

- **2** [Development of tidy R OMOP CDM packages](TODO) *under construction*

- **3** [DrugUtilisation in the OMOP CDM](TODO) *under construction*

## Support us

We encourage you to support this work by: either citing the book in your papers or documentation; recommending it to your colleagues; starring the [GitHub repository](TODO); or simply letting us know how it helped you. But on top of that **use it** so it can help you and others in your research.
