...
In this first half of the book we will see how we can work with databases from R in general. In the following chapters we'll see that when working with data held in a relational database we can leverage various open-source R packages to help us perform tidyverse-style data analyses.
...
-   In @sec-tidyverse_expressions we will see how we can perfom more complex data manipulation via translation of R code into SQL specific to the database management system being used.
