...
For this chapter, lets use an example COVID-19 dataset.
...
When working with dates, the best supported functions come from the [clock](https://clock.r-lib.org/) package. In particular, the following three functions can allow us to do a lot of the date manipulations we might be interested in:
