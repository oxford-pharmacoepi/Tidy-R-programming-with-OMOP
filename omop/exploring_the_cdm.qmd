...
For this chapter, we'll use a synthetic COVID-19 dataset (`"synthea-covid19-10k"`) that can be downloaded with the [**omock**](https://ohdsi.github.io/omock/) package. A characterisation of this dataset to better understand its content can be found in the following Shiny App <https://dpa-pde-oxford.shinyapps.io/OmopSketchCharacterisation/>.
...
Note running the above line of code can take several hours or even days depending on the size of the database. Once you have the results you can visualise all of them within a Shiny App such as the one shown at the beginning of this chapter.
