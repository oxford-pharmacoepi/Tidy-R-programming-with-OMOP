...
Although the [`cdmName()`](https://darwin-eu.github.io/omopgenerics/reference/cdmName.html) and [`cdmVersion()`](https://darwin-eu.github.io/omopgenerics/reference/cdmVersion.html) functions are defined by the omopgenerics packages, these functions are re-exported in other packages and so you won't need to load omopgenerics explicitly.
:::
