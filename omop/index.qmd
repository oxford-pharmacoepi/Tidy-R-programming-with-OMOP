...
-   In @sec-adding_features we will see how to add demographics information to different tables of interest and summarise it using dplyr code. Finally we will also see how use tidyverse verbs to add some custom features.

-   In @sec-creating_cohorts we will have a look to the cohort object, how it is defined and what are their attributes. We we also see how to create some simple base cohorts and apply some inclusion criteria to them.
