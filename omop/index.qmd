...
-   In @sec-adding_features we will see how to add demographics information to different tables of interest and summarize it using dplyr code. Finally, we will also see how to use tidyverse verbs to add some custom features.
