...
We can visualize the attrition with the CohortCharacteristics package. We can first extract it with `summarizeCohortAttrition()` and then `plotCohortAttrition` to better view the impact of applying each inclusion criteria:
