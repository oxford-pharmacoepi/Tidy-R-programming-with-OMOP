...
![Lahman's Baseball Dabatase schema from <https://cdalzell.github.io/Lahman/>](../images/lahman.jpg){.lightbox #fig-lahman}
...
Using this approach, we can make use of various utility functions. For example here we specify [primary and foreign keys](TODO%20add%20citation) and then check that the key constraints are satisfied.
