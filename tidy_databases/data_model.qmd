...
In this chapter we will be creating a bespoke data model for our database. This approach can be further extended using the `dm` package [@dm], which also provides various helpful functions for creating a data model and working with it.
